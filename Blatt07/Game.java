...
// You will implement this method
    ...
    public void processInput() {
        ...
        else System.out.println("Please enter exactly one letter");
        return;
    }

    protected void handleGuess(char guess) {
        if (guessedLetters.contains(guess)) {
            System.out.println("Der Buchstabe: " + guess + " wurde bereits erraten.");
            return;
        }
        ...
        if (hasWon()) endGame(hasWon());
        else if (attemptsLeft <= 0)endGame(hasWon());
    }
    ...
    private boolean hasWon() {
       ...
       return guessedLetters.containsAll(Buchstaben);
    }

    protected void endGame(boolean won) {
        if (won) System.out.println("Korrekt, das Wort ist: " + currentWord + ".");
        else System.out.println("Falsch, das Wort ist : " + currentWord + ".");
